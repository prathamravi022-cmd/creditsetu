...
function LangToggle() {
  ...
  var label = current === "en" ? "HI" : "EN";
  return (<button onClick={function(){i18n.changeLanguage(next)}} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold border border-gray-200 dark:border-gray-600 hover:border-[#138808] hover:bg-[#138808]/5 transition-all text-gray-600"><Globe className="w-3.5 h-3.5" />{label}</button>);
}
  ...
  return (<div className="min-h-screen bg-white dark:bg-gray-900">
    ...
    <nav className="fixed top-1 left-0 right-0 z-50 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border-b border-gray-100 dark:border-gray-700 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 lg:px-16 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3"><LangToggle /><Link to={ctaPath} className="hidden sm:inline-flex px-5 py-2.5 rounded-lg text-sm font-semibold text-white bg-[#FF9933] hover:bg-[#e68a2d] transition-colors shadow-md">{t("landing.hero.get_started_btn")}</Link><button onClick={function(){setMenuOpen(!menuOpen)}} className="lg:hidden w-10 h-10 rounded-lg flex items-center justify-center text-gray-600 hover:bg-gray-100">{menuOpen ? <X className="w-5 h-5" /> : <Menu className="w-5 h-5" />}</button></div>
      </div></nav>
    <section ref={heroRef} className="relative pt-24 pb-16 px-6 lg:px-16 min-h-[80vh] flex items-center overflow-hidden">
      <div className="absolute inset-0 z-0"><img src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=1600&q=80" alt="" className="w-full h-full object-cover" /><div className="absolute inset-0 bg-gradient-to-r from-white via-white/90 to-white/60" /><div className="absolute inset-0 bg-[#138808]/5" /></div>
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className={"transition-all duration-700 ease-out " + (heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")} style={{transitionDelay:"0.1s"}}><div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#138808]/10 border border-[#138808]/20 mb-6"><Shield className="w-4 h-4 text-[#138808]" /><span className="text-[#138808] text-sm font-medium">{t("landing.hero.badge")}</span></div><h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#000080] leading-tight mb-6">{t("landing.hero.title")}</h1><p className="text-lg text-gray-600 mb-8 leading-relaxed">{t("landing.hero.subtitle")}</p><div className="flex flex-col sm:flex-row gap-4"><Link to={ctaPath} className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg text-white font-semibold bg-[#138808] hover:bg-[#0f6d06] transition-colors shadow-lg">{t("landing.hero.cta")} <ArrowRight className="w-5 h-5" /></Link><Link to="/schemes" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg font-semibold border-2 border-[#FF9933] text-[#FF9933] hover:bg-[#FF9933]/10 transition-colors">{t("landing.hero.view_all")}</Link></div></div>
        <div className="relative hidden lg:block"><HeroIllustration /></div>
      </div></section>
    <section className="py-12 px-6 lg:px-16 bg-[#000080]"><div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8"><div ref={s1Ref} className="text-center"><div className="text-3xl md:text-4xl font-extrabold text-white mb-1">{s1Val}</div><div className="text-sm text-white/70 uppercase tracking-wider">{t("landing.stats.schemes")}</div></div><div ref={s2Ref} className="text-center"><div className="text-3xl md:text-4xl font-extrabold text-white mb-1">{s2Val}</div><div className="text-sm text-white/70 uppercase tracking-wider">{t("landing.stats.partners")}</div></div><div ref={s3Ref} className="text-center"><div className="text-3xl md:text-4xl font-extrabold text-white mb-1">₹{s3Val}</div><div className="text-sm text-white/70 uppercase tracking-wider">{t("landing.stats.disbursed")}</div></div><div ref={s4Ref} className="text-center"><div className="text-3xl md:text-4xl font-extrabold text-white mb-1">{s4Val}</div><div className="text-sm text-white/70 uppercase tracking-wider">{t("landing.stats.districts")}</div></div></div></section>

    <section id="how-it-works" ref={stepsRef} className="relative py-20 px-6 lg:px-16 overflow-hidden"><div className="absolute inset-0 z-0"><img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=1600&q=80" alt="" className="w-full h-full object-cover" /><div className="absolute inset-0 bg-white/95 dark:bg-gray-900/95" /></div><div className="max-w-7xl mx-auto relative z-10"><div className={"text-center mb-16 transition-all duration-700 " + (stepsVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}><h2 className="text-3xl md:text-4xl font-bold text-[#000080] mb-4">{t("landing.features.title")}</h2><div className="w-16 h-1 bg-[#FF9933] mx-auto rounded-full" /></div><div className="grid grid-cols-1 md:grid-cols-3 gap-8">{steps.map(function(step, i) { var StepIcon = step.icon; return (<div key={i} className={"relative p-8 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 " + (stepsVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")} style={{transitionDelay: (i*150)+"ms"}}><div className="absolute -top-4 left-8 w-8 h-8 rounded-full bg-[#FF9933] text-white flex items-center justify-center font-bold text-sm">{i + 1}</div><div className="mb-6"><StepIcon /></div><h3 className="text-xl font-bold text-[#000080] mb-3">{step.title}</h3><p className="text-gray-600 text-sm leading-relaxed">{step.desc}</p></div>);})}</div></div></section>

    <section id="schemes" ref={schemesRef} className="relative py-20 px-6 lg:px-16 overflow-hidden"><div className="absolute inset-0 z-0"><img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=1600&q=80" alt="" className="w-full h-full object-cover" /><div className="absolute inset-0 bg-gray-50/95 dark:bg-gray-900/95" /></div><div className="max-w-7xl mx-auto relative z-10"><div className={"text-center mb-16 transition-all duration-700 " + (schemesVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}><h2 className="text-3xl md:text-4xl font-bold text-[#000080] mb-4">{t("landing.schemes.title")}</h2><div className="w-16 h-1 bg-[#138808] mx-auto rounded-full" /></div><div className="grid grid-cols-1 md:grid-cols-3 gap-8">{schemes.map(function(scheme, i) { var SchemeIcon = scheme.icon; return (<div key={i} className={"relative p-8 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 " + (schemesVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")} style={{transitionDelay: (i*150)+"ms"}}><div className="absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-semibold bg-[#FF9933]/10 text-[#FF9933] border border-[#FF9933]/20">{scheme.badge}</div><div className="w-14 h-14 rounded-xl bg-[#138808]/10 flex items-center justify-center mb-6"><SchemeIcon className="w-7 h-7 text-[#138808]" /></div><h3 className="text-xl font-bold text-[#000080] mb-3">{scheme.name}</h3><p className="text-gray-600 text-sm leading-relaxed mb-6">{scheme.desc}</p><div className="flex items-center justify-between pt-5 border-t border-gray-100"><span className="text-sm text-gray-500">{scheme.range}</span><span className="text-sm font-bold text-[#138808]">{scheme.rate}</span></div></div>);})}</div></div></section>
    <section ref={testiRef} className="py-20 px-6 lg:px-16 bg-white dark:bg-gray-900"><div className="max-w-7xl mx-auto"><div className={"text-center mb-16 transition-all duration-700 " + (testiVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}><h2 className="text-3xl md:text-4xl font-bold text-[#000080] mb-4">{t("landing.process.title")}</h2><div className="w-16 h-1 bg-[#FF9933] mx-auto rounded-full" /><p className="text-gray-500 mt-4 max-w-xl mx-auto">{t("landing.process.subtitle")}</p></div><div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">{[{ icon: "form", step: "01", title: t("landing.process.step1.title"), desc: t("landing.process.step1.desc") },{ icon: "ai", step: "02", title: t("landing.process.step2.title"), desc: t("landing.process.step2.desc") },{ icon: "doc", step: "03", title: t("landing.process.step3.title"), desc: t("landing.process.step3.desc") },{ icon: "bank", step: "04", title: t("landing.process.step4.title"), desc: t("landing.process.step4.desc") }].map(function(item, i) { var iconEl; if (item.icon === "form") iconEl = (<svg className="w-10 h-10" viewBox="0 0 48 48" fill="none"><rect x="8" y="6" width="32" height="36" rx="4" stroke="#FF9933" strokeWidth="2.5" fill="none"/><line x1="14" y1="16" x2="34" y2="16" stroke="#FF9933" strokeWidth="2" strokeLinecap="round"/><line x1="14" y1="22" x2="30" y2="22" stroke="#FF9933" strokeWidth="2" strokeLinecap="round"/><line x1="14" y1="28" x2="26" y2="28" stroke="#FF9933" strokeWidth="2" strokeLinecap="round"/><circle cx="34" cy="34" r="6" fill="#138808"/><path d="M31 34l2 2 4-4" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>); else if (item.icon === "ai") iconEl = (<svg className="w-10 h-10" viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="16" stroke="#138808" strokeWidth="2.5" fill="none"/><circle cx="24" cy="24" r="6" fill="#138808" opacity="0.2"/><path d="M24 8v4M24 36v4M8 24h4M36 24h4" stroke="#138808" strokeWidth="2" strokeLinecap="round"/><path d="M13 13l3 3M32 32l3 3M13 35l3-3M32 16l3-3" stroke="#138808" strokeWidth="2" strokeLinecap="round"/></svg>); else if (item.icon === "doc") iconEl = (<svg className="w-10 h-10" viewBox="0 0 48 48" fill="none"><path d="M12 8h18l8 8v24a4 4 0 01-4 4H12a4 4 0 01-4-4V12a4 4 0 014-4z" stroke="#FF9933" strokeWidth="2.5" fill="none"/><path d="M30 8v8h8" stroke="#FF9933" strokeWidth="2.5" fill="none"/><path d="M16 24h16M16 30h10" stroke="#FF9933" strokeWidth="2" strokeLinecap="round"/><circle cx="34" cy="34" r="6" fill="#138808"/><path d="M31 34l2 2 4-4" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>); else iconEl = (<svg className="w-10 h-10" viewBox="0 0 48 48" fill="none"><rect x="6" y="20" width="36" height="22" rx="3" stroke="#138808" strokeWidth="2.5" fill="none"/><path d="M16 20V14a8 8 0 0116 0v6" stroke="#138808" strokeWidth="2.5" fill="none"/><circle cx="24" cy="31" r="3" fill="#138808"/><path d="M24 34v3" stroke="#138808" strokeWidth="2" strokeLinecap="round"/><path d="M14 12l4 4M34 12l-4 4" stroke="#138808" strokeWidth="2" strokeLinecap="round"/></svg>); return (<div key={i} className={"relative p-6 rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 text-center " + (testiVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")} style={{transitionDelay: (i*150)+"ms"}}><div className="absolute -top-3 left-1/2 -translate-x-1/2 w-7 h-7 rounded-full bg-[#FF9933] text-white flex items-center justify-center font-bold text-xs">{item.step}</div><div className="flex justify-center mb-4 mt-2">{iconEl}</div><h3 className="font-bold text-[#000080] mb-2">{item.title}</h3><p className="text-gray-500 text-sm leading-relaxed">{item.desc}</p></div>);})}</div></div></section><section ref={ctaRef} className={"relative py-20 px-6 lg:px-16 overflow-hidden transition-all duration-700 bg-[#138808] dark:bg-gray-950 " + (ctaVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}><div className="max-w-4xl mx-auto text-center"><h2 className="text-3xl md:text-4xl font-bold text-white mb-6">{t("landing.cta.title")}</h2><p className="text-lg text-white/80 mb-10">{t("landing.cta.subtitle")}</p><Link to={ctaPath} className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg text-[#138808] font-semibold bg-white hover:bg-gray-100 transition-colors shadow-lg">{t("landing.hero.get_started")} <ArrowRight className="w-5 h-5" /></Link></div></section>

    <footer id="contact" className="bg-[#000080] py-12 px-6 lg:px-16">
      <div className="max-w-7xl mx-auto">
        <div className="bg-[#FF9933]/10 border border-[#FF9933]/20 rounded-2xl p-6 mb-10 flex flex-col md:flex-row items-center justify-between gap-4"><div className="flex items-center gap-3"><Phone className="w-6 h-6 text-[#FF9933]" /><div><div className="text-white font-semibold text-lg">{t("landing.footer.helpline")}</div><div className="text-[#FF9933] font-bold text-xl">{helpline}</div></div></div><div className="text-white/50 text-sm text-center md:text-right">{t("landing.footer.available_247")}</div></div>
